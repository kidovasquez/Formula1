...
mount_adls('formula1dlkaran','demo')

# COMMAND ----------

mount_adls('formula1dlkaran','raw')

# COMMAND ----------

mount_adls('formula1dlkaran','processed')

# COMMAND ----------

mount_adls('formula1dlkaran','presentation')